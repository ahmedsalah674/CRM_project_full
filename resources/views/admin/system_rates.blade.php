      ...
      @php($counter=0)
          ...
          <tr>
            ...
            @endif
              ...
              <td>
              <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modalPush{{$counter}}"><i class="fas fa-eye"></i> Show</button>
                <!--Modal: modalPush-->
        ...
        <div class="  ">{{$rates->appends(['sort' => 'created_at'])->links()}}</div>
        </div> --}}
