      ...
      <tr>
          ...
          @endif
            ...
            <td>
              ...
              <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modalPush{{$index}}">Delete <i class="fas fa-trash"></i></button>
                    <!--Modal: modalPush-->
                      ...
                      <div class="modal-dialog modal-notify modal-info" role="document" >
                        ...
                        <div class="modal-content text-center" >
                          ...
                          <form action="{!!route('user.delete')!!}" method="POST" delete="delete{{$user->id}}" class="delete{{$user->id}}">
                            ...
                            @method('DELETE')
                            <input type="hidden" name="destroy_id" value="{{$user->id}}">
                            <button type="submit" class="btn btn-danger m-2">Delete <i class="fas fa-trash"></i></button>
                          </form>
